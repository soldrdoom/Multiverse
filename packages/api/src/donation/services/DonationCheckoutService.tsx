			...
			const lineItem: Stripe.Checkout.SessionCreateParams.LineItem = isRecurring
				? {
						price_data: {
							...
							product_data: {
								name: 'Multiverse Recurring Donation',
								description: `${params.interval === 'month' ? 'Monthly' : 'Yearly'} donation to support Multiverse`,
							},
				...
				: {
						price_data: {
							currency: params.currency,
							product_data: {
								name: 'Multiverse Donation',
								description: 'One-time donation to support Multiverse',
							},
							unit_amount: params.amountCents,
						},
						quantity: 1,
