...
export class DownloadService {
	...
	private buildPossibleFilenames(
		...
		if (format === 'setup') {
			...
			filenames.push(`Multiverse-${channel}-${version}-${archSuffix}-Setup${ext}`);
			filenames.push(`fluxer-${version}-${archSuffix}-setup${ext}`);
			filenames.push(`Multiverse-${version}-${archSuffix}-Setup${ext}`);
		} else {
			filenames.push(`fluxer-${channel}-${version}-${archSuffix}${ext}`);
			filenames.push(`fluxer-${version}-${archSuffix}${ext}`);
			filenames.push(`Multiverse-${channel}-${version}-${archSuffix}${ext}`);
			filenames.push(`Multiverse-${version}-${archSuffix}${ext}`);
		}
