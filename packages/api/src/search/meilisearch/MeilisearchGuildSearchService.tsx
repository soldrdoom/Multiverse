...
import type {MeilisearchGuildAdapterOptions} from '@fluxer/meilisearch_search/src/adapters/MeilisearchGuildAdapter';
import {MeilisearchGuildAdapter} from '@fluxer/meilisearch_search/src/adapters/MeilisearchGuildAdapter';
