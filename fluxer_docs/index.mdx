...
Fluxer's APIs are consistent as long as you're running the latest Fluxer Server version against the official Multiverse deployment, operated by Multiverse Platform AB. Just make sure you use the correct base URLs for the instance you're targeting.
