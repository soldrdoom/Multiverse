...
Fluxer's APIs are consistent as long as you're running the latest Fluxer Server version against the official Multiverse deployment. Just make sure you use the correct base URLs for the instance you're targeting.
...
These docs are more comprehensive than you might be used to from Discord since they cover not only bot-facing APIs, but also instance management APIs and client-specific APIs (since Fluxer encourages you to build third-party clients). If you're just looking to build a bot, you can safely skip over sections that don't interest you.
...
<CardGroup cols={2}>
	<Card title="Bot platform" icon="robot" href="/bots/overview">
		Applications, named tokens, teams, and the first-party SDK.
	</Card>
