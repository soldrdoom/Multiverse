...
<a id="admincreatorapplicationentry"></a>
...
<a id="admincreatorapplicationsresponse"></a>

## AdminCreatorApplicationsResponse

**Related endpoints**

- [`GET /admin/creator-applications`](/api-reference/admin/list-creator-applications)

| Field | Type | Description |
|-------|------|-------------|
| applications | [AdminCreatorApplicationEntry](#admincreatorapplicationentry)[] |  |

<a id="admincreatorentry"></a>
...
| commission_rate | integer (int53) |  |
| creator_id | integer (int53) |  |
| payout_suspended | boolean |  |
| solana_address | string |  |

<a id="admincreatorsresponse"></a>

## AdminCreatorsResponse

**Related endpoints**

- [`GET /admin/creators`](/api-reference/admin/list-approved-creators)

| Field | Type | Description |
|-------|------|-------------|
| creators | [AdminCreatorEntry](#admincreatorentry)[] |  |

<a id="adminlistingsresponse"></a>

## AdminListingsResponse

**Related endpoints**

- [`GET /admin/creator-listings`](/api-reference/admin/list-all-creator-listings)

| Field | Type | Description |
|-------|------|-------------|
| listings | [CreatorListingEntry](#creatorlistingentry)[] |  |

<a id="adminupdatecreatorrequest"></a>

## AdminUpdateCreatorRequest

**Related endpoints**

- [`PATCH /admin/creators/{id}`](/api-reference/admin/update-a-creator-record)

| Field | Type | Description |
|-------|------|-------------|
| commission_rate? | integer (int32) |  |
| payout_suspended? | boolean |  |
| solana_address? | string |  |
...
<a id="createnewsstoryrequest"></a>

## CreateNewsStoryRequest

**Related endpoints**

- [`POST /admin/news/create`](/api-reference/admin/create-a-news-story)

| Field | Type | Description |
|-------|------|-------------|
| body | string | Body content of the news story |
| image_data? | ?string | Base64 data URL of an uploaded image; takes precedence over image_url when present |
| image_url? | ?string | URL of the image shown at the top of the news card |
...
<a id="deletenewsstoryresponse"></a>

## DeleteNewsStoryResponse

**Related endpoints**

- [`POST /admin/news/delete`](/api-reference/admin/delete-a-news-story)

| Field | Type | Description |
|-------|------|-------------|
| story_id | [SnowflakeType](#snowflaketype) |  |
...
- [`GET /admin/news/{story_id}`](/api-reference/admin/get-a-news-story)
...
- [`GET /guilds/{guildId}/cosmetics`](/api-reference/cosmetics/get-applied-server-cosmetics)
...
- [`GET /users/{user_id}/application-commands`](/api-reference/oauth2/list-a-users-application-commands)
- [`GET /users/{userId}/cosmetics`](/api-reference/cosmetics/get-applied-profile-cosmetics-for-a-user)
...
- [`GET /users/@me/cosmetics`](/api-reference/cosmetics/get-applied-profile-cosmetics)
...
- [`POST /admin/bulk/update-guild-features`](/api-reference/admin/bulk-update-guild-features)
- [`POST /admin/bulk/update-user-flags`](/api-reference/admin/bulk-update-user-flags)
- [`POST /admin/creator-applications/{address}/approve`](/api-reference/admin/approve-a-creator-application)
- [`POST /admin/creator-applications/{address}/reject`](/api-reference/admin/reject-a-creator-application)
- [`POST /admin/creator-listings/{id}/approve`](/api-reference/admin/approve-a-creator-listing)
- [`POST /admin/creator-listings/{id}/reject`](/api-reference/admin/reject-a-creator-listing)
- [`POST /admin/discovery/applications/{guild_id}/approve`](/api-reference/admin/approve-discovery-application)
- [`POST /admin/discovery/applications/{guild_id}/reject`](/api-reference/admin/reject-discovery-application)
- [`POST /admin/discovery/guilds/{guild_id}/remove`](/api-reference/admin/remove-guild-from-discovery)
...
- [`POST /admin/news/create`](/api-reference/admin/create-a-news-story)
- [`POST /admin/news/delete`](/api-reference/admin/delete-a-news-story)
- [`POST /admin/news/list`](/api-reference/admin/list-news-stories)
- [`POST /admin/news/publish`](/api-reference/admin/publish-a-news-story)
- [`POST /admin/news/unpublish`](/api-reference/admin/unpublish-a-news-story)
- [`POST /admin/news/update`](/api-reference/admin/update-a-news-story)
...
- [`POST /admin/users/update-visionary`](/api-reference/admin/grant-or-revoke-visionary-status)
...
- [`POST /channels/{channel_id}/interactions`](/api-reference/channels/invoke-a-bot-application-command)
...
- [`POST /channels/{channel_id}/token-gate/recheck`](/api-reference/channels/recheck-the-current-users-access-to-a-gated-channel)
...
- [`POST /users/@me/solana-wallet`](/api-reference/users/link-a-solana-wallet)
...
- [`PUT /applications/@me/commands`](/api-reference/oauth2/bulk-overwrite-application-commands)
...
- [`PUT /channels/{channel_id}/token-gate`](/api-reference/channels/set-the-tokengate-for-a-channel-or-category)
- [`PUT /channels/{channel_id}/token-gate/visibility`](/api-reference/channels/set-how-a-channelcategory-appears-to-members-who-fail-its-tokengate)
...
- [`DELETE /channels/{channel_id}/token-gate`](/api-reference/channels/clear-the-tokengate-for-a-channel-or-category)
- [`DELETE /creators/@me/listings/{id}`](/api-reference/creators/delete-a-draft-cosmetic-listing)
...
- [`DELETE /oauth2/applications/{client_id}/bot/tokens/{token_id}`](/api-reference/oauth2/revoke-bot-token)
...
- [`DELETE /teams/{team_id}`](/api-reference/oauth2/delete-team)
- [`DELETE /teams/{team_id}/members/{user_id}`](/api-reference/oauth2/remove-team-member)
...
<a id="listnewsstoriesresponse"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| stories | [NewsStoryAdminResponse](#newsstoryadminresponse)[] |  |
...
| body | string |  |
| created_at | string |  |
| created_by_user_id | [SnowflakeType](#snowflaketype) |  |
| image_url | ?string |  |
| published_at | ?string |  |
| status | [NewsStoryStatusSchema](#newsstorystatusschema) |  |
| story_id | [SnowflakeType](#snowflaketype) |  |
| title | string |  |
| updated_at | string |  |

<a id="newsstoryidrequest"></a>
...
<a id="updateuservisionaryrequest"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| granted | boolean | Whether to grant (true) or revoke (false) the Visionary lifetime badge |
| user_id | [SnowflakeType](#snowflaketype) |  |
