...
<a id="linksolanawalletrequest"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| address | string | Base58-encoded Solana wallet address to link to this account |
| nonce | string | Nonce previously issued by POST /auth/solana/nonce for this address |
| signature | string | Base64-encoded Ed25519 signature over the challenge message |
| signedMessage? | string | Exact base64-encoded bytes the wallet signed, when reported by a Wallet Standard signIn() wallet |

<a id="linksolanawalletresponse"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| solana_address | string | The Solana wallet address now linked to this account |
...
<a id="profilecosmeticslotschema"></a>
...
<a id="usercosmeticspublicresponse"></a>
...
| has_solana_wallet? | boolean | Whether this user has a Solana wallet linked (can receive tips) |
