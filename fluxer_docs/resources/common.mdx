...
- [`GET /nfts`](/api-reference/cosmetics/list-cosmetic-nfts-in-the-current-users-wallet)

| Field | Type | Description |
|-------|------|-------------|
| nfts | [OwnedCosmeticNft](#ownedcosmeticnft)[] |  |

<a id="ownedcosmeticnft"></a>
...
| Field | Type | Description |
|-------|------|-------------|
| nft | [OwnedCosmeticNft](#ownedcosmeticnft) |  |
| ok | boolean |  |
