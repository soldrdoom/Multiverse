...
<a id="cosmeticsinvoiceresponse"></a>

## CosmeticsInvoiceResponse

**Related endpoints**

- [`POST /cosmetics/store/{itemId}/invoice`](/api-reference/cosmetics/create-a-purchase-invoice-for-a-cosmetic-item)

| Field | Type | Description |
|-------|------|-------------|
| creator_lamports | integer (int53) |  |
| creator_wallet | string |  |
| item_id | [SnowflakeType](#snowflaketype) |  |
| platform_lamports | integer (int53) |  |
| platform_wallet | string |  |
| purchase_id | [SnowflakeType](#snowflaketype) |  |
