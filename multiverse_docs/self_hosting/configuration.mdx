...
| Property | Type | Description |
|----------|------|-------------|
| bluesky? | [bluesky](#bluesky) | Bluesky OAuth client configuration. Default: `{"enabled":true,"client_name":"Fluxer","client_uri":"","logo_uri":"/web/apple-touch-icon.png","tos_uri":"https://fluxer.app/terms","policy_uri":"https://fluxer.app/privacy","keys":[]}` |
...
| logo_uri? | string | Optional logo presented during authorization. Default: `/web/apple-touch-icon.png` |
...
```json
{
  ...
  "enabled": true,
  "keys": [],
  "logo_uri": "/web/apple-touch-icon.png",
